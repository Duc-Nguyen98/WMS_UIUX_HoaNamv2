...
await copy('components/scanner-launcher.tsx');
await copy('components/scanner-intent-scan.tsx');
await copy('components/scanner-global.css');
await copy('lib/scanner-intent.ts');
